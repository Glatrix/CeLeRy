...
bool IsCrashHandler() {
	bool check_1 = GetModuleHandleA("UnityCrashHandler32.exe") != NULL;
	bool check_2 = GetModuleHandleA("UnityCrashHandler64.exe") != NULL;
	bool check_3 = GetModuleHandleA("UnityCrashHandler.exe")   != NULL;
...
DWORD WINAPI Load(LPVOID lpParam) {
	...
	LoadLibraryA(".\\CeLeRy\\Ijwhost.dll");
	LoadLibraryA(".\\CeLeRy\\clrhost.dll");
